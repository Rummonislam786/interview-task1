   ...
   <div className="min-h-screen bg-gray-50 py-8 px-2 sm:py-12 sm:px-4">
      <div className="max-w-4xl mx-auto w-full">
        <div className="bg-white p-4 sm:p-8 shadow-sm rounded-lg border flex flex-col w-full">
          ...
          <div className="space-y-4 sm:space-y-6 mb-3">
            <div className="flex flex-col sm:flex-row items-start sm:items-center sm:space-x-2 space-y-2 sm:space-y-0">
              ...
              <div className="flex-1 space-y-2 sm:space-y-4">
                <div>
                  <h3 className="text-sm sm:text-base font-small text-gray-900 mb-1 font-bold">
              ...
              <input className="w-full sm:w-1/2 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 placeholder-gray-400"/>
            </div>
          </div>
          <div className="space-y-4 sm:space-y-6 mb-3">
          <div className="flex flex-col sm:flex-row items-start sm:items-center sm:space-x-2 space-y-2 sm:space-y-0">
              ...
              <div className="flex-1 space-y-2 sm:space-y-4 gap-4">
                <div>
                  <h3 className="text-sm sm:text-base font-small text-gray-900 mb-1 font-bold">
                    Give your online store a name
                  </h3>
          ...
          <button className="w-full sm:w-1/3 md:w-1/5 bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition-colors duration-200 self-end mt-4">Create Store</button>
        </div>
      </div>
    </div>
  );
